...
class VueSolaire():
    def __init__(self,fen,parent):
        ...
        self.boutonsVais=[]
        self.vaisCanonCan=Image.open("2019_01_Orion_AI/images/vaisseauCanon.png")
        self.vaisEclaireurCa=Image.open("2019_01_Orion_AI/images/vaisseauEclaireur.png")
        self.vaisLaserCa=Image.open("2019_01_Orion_AI/images/vaisseauLaser.png")
        self.vaisSniperCa=Image.open("2019_01_Orion_AI/images/vaisseauSniper.png")
        self.vaisTankCa=Image.open("2019_01_Orion_AI/images/vaisseauTank.png")
        #self.drawing=PhotoImage(file="2019_01_Orion_AI/images/vaisseauCanon.png")
        self.vaisCanonCan=resizeImage.resizeVaisseauCanvas(30,"2019_01_Orion_AI/images/vaisseauCanon.png")
        self.vaisEclaireurCa=resizeImage.resizeVaisseauCanvas(30,"2019_01_Orion_AI/images/vaisseauEclaireur.png")
        self.vaisLaserCa=resizeImage.resizeVaisseauCanvas(30,"2019_01_Orion_AI/images/vaisseauLaser.png")
        self.vaisSniperCa=resizeImage.resizeVaisseauCanvas(30,"2019_01_Orion_AI/images/vaisseauSniper.png")
        self.vaisTankCa=resizeImage.resizeVaisseauCanvas(30,"2019_01_Orion_AI/images/vaisseauTank.png")
        self.tk_vaisCanonCan = ImageTk.PhotoImage(self.vaisCanonCan)
        self.newVais1 = Button(self.cadreinfo,image=self.tk_vaisCanonCan,bg="DeepSkyBlue2")
        self.vaisCanonCan=Image.open
