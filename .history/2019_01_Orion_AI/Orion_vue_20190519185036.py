...
class VueSolaire():
    def __init__(self,fen,parent):
        ...
        self.newVais1 = Button(self.cadreinfo,image=self.vaisCanonCan,bg="DeepSkyBlue2")
        self.newVais2 = Button(self.cadreinfo,image=self.vaisEclaireurCa,bg="DeepSkyBlue2" )
        self.newVais3 = Button(self.cadreinfo,image=self.vaisTankCa,bg="DeepSkyBlue2")
        self.newVais4 = Button(self.cadreinfo,image=self.vaisLaserCa,bg="DeepSkyBlue2")
        self.newVais5 = Button(self.cadreinfo,image=self.vaisSniperCa,bg="DeepSkyBlue2")
