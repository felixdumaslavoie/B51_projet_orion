        ...
        if len(self.planete.listeStructure) > 0:
            for i in self.planete.listeStructure:
                ...
                if(i.nom="Raffinerie (Charbon)"):
                    ...
                    self.canevasPlanete.create_image(self.x,self.y,image= self.raffinerieMilitaireCanvas, tags=("batiment_construit"))
                elif(i.nom="Usine Civile"):
                    self.canevasPlanete.create_image(self.x,self.y,image= self.raffinerieCivileCanvas, tags=("batiment_construit"))
                elif(i.nom="Capitale"):
                    self.canevasPlanete.create_image(self.x,self.y,image= self.raffinerieCapitaleCanvas, tags=("batiment_construit"))
                elif(i.nom="Ferme"):
                    self.canevasPlanete.create_image(self.x,self.y,image= self.raffinerieFermeCanvas, tags=("batiment_construit"))
