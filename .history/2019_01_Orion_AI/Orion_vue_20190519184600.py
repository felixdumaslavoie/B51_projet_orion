...
class VueSolaire():
    def __init__(self,fen,parent):
        ...
        self.tk_vaisCanonCan=resizeImage.resizeVaisseauCanvas(30,"2019_01_Orion_AI/images/vaisseauCanon.png",self.vaisCanonCan)
        resizeImage.resizeVaisseauCanvas(30,"2019_01_Orion_AI/images/vaisseauEclaireur.png",self.vaisEclaireurCa)
