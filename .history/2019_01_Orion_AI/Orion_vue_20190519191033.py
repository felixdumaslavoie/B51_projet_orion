...
class VueSolaire():
    def __init__(self,fen,parent):
        ...
        self.vaisEclaireurCan=resizeImage.resizeVaisseau("m",30,"2019_01_Orion_AI/images/vaisseauEclaireur.png")
        self.vaisLaserCan=resizeImage.resizeVaisseau("m",30,"2019_01_Orion_AI/images/vaisseauLaser.png")
        self.vaisSniperCan=resizeImage.resizeVaisseau("m",30,"2019_01_Orion_AI/images/vaisseauSniper.png")
        self.vaisTankCan=resizeImage.resizeVaisseau("m",30,"2019_01_Orion_AI/images/vaisseauTank.png")
        self.newVais1 = Button(self.cadreinfo,image=self.vaisCanonMenu,text="Vaisseau Canon",bg="DeepSkyBlue2")
        self.newVais2 = Button(self.cadreinfo,image=self.vaisEclaireurm,text="Vaisseau Eclaireur",bg="DeepSkyBlue2" )
