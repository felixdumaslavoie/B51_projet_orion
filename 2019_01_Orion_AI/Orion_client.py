...
class Controleur():
    ...
    def creerpartie(self):
        if self.egoserveur==0:
            ...
            print ("voici cwd v2   " + os.getcwd())
            print("voici le directory   " + dir_path)

            if dir_path != os.getcwd():
                directory = os.getcwd() + '/2019_01_Orion_AI/Orion_serveur.py'
            else:
                directory = dir_path + '/Orion_serveur.py'

            pid = Popen([sys.executable, directory],shell=1).pid # A changer SELON L'IDE UTILISER
